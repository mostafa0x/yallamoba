...
export default function AvatarIcons(props: any) {
    ...
    return (
        <div>
            <label className="block text-sm mb-12">Choose your profile picture</label>
            ...
            {props.Formik.errors.avatar && props.Formik.touched.avatar ?
                <h1 className='text-red-500 opacity-70 animate-shake animate-once py-2'>{props.Formik.errors.avatar}</h1>
